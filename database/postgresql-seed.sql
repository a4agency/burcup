...
VALUES
  ('almaz-antey', 'Алмаз-Антей', 'Алмаз-Антей', 'images/team-almaz-antey.png', 'Россия', 'Санкт-Петербург', 'Футбольный клуб, регулярно участвующий в турнирах Burchalkin Cup.'),
  ('zenit', 'Зенит', 'Зенит', 'images/team-zenit.png', 'Россия', 'Санкт-Петербург', 'Один из ключевых клубов турнирной сетки и истории матчей сайта.'),
  ('palmeiras', 'Палмейрас', 'Палмейрас', 'images/team-palmeiras.png', 'Бразилия', NULL, 'Международный участник турнира Burchalkin Cup.'),
  ('kairat', 'Кайрат', 'Кайрат', 'images/team-kairat.png', 'Казахстан', 'Алматы', 'Клуб для международной турнирной линейки и страницы истории матчей.'),
  ('crvena-zvezda', 'Црвена Звезда', 'Црвена Звезда', 'images/team-crvena-zvezda.png', 'Сербия', 'Белград', 'Участник международного состава турнира.'),
  ('fenerbahce', 'Фенербахче', 'Фенербахче', 'images/team-fenerbahce.png', 'Турция', 'Стамбул', 'Клуб для будущих и архивных сезонов турнира.'),
  ('san-lorenzo', 'Сан-Лоренсо', 'Сан-Лоренсо', 'images/team-san-lorenzo.png', 'Аргентина', 'Буэнос-Айрес', 'Клуб с будущими и архивными матчами в общей истории сайта.'),
  ('dinamo-minsk', 'Динамо-Минск', 'Динамо-Минск', 'images/team-dinamo-minsk.png', 'Беларусь', 'Минск', 'Клуб для турнирной истории и карточки команды.')
ON CONFLICT (slug) DO UPDATE
SET
  name = EXCLUDED.name,
...
FROM (
  VALUES
    (1::BIGINT, 'burchalkin-cup-2026', 'Группа A', '1 тур', 'День 1', NULL::DATE, '10:00'::TIME, 'done', 'Завершен', 'almaz-antey', 'crvena-zvezda', 10, 3, 'Стадион «Алмаз-Антей»', 'https://vkvideo.ru/video_ext.php?oid=-120721420&id=456239434&hash=a4ca6ca1e82ce6c4&hd=4', 'Открывающий матч игрового дня. На этой странице можно показывать прямой эфир или запись игры.', 1),
    (2::BIGINT, 'burchalkin-cup-2026', 'Группа A', '1 тур', 'День 1', NULL::DATE, '12:00'::TIME, 'live', 'В эфире', 'zenit', 'kairat', 4, 1, 'Главное поле', 'https://vkvideo.ru/video_ext.php?oid=-120721420&id=456239431&hash=90e82e3d00ac220b&hd=4', 'Матч идёт в прямом эфире', 2),
    (3::BIGINT, 'burchalkin-cup-2026', 'Группа B', '1 тур', 'День 1', NULL::DATE, '14:00'::TIME, 'soon', 'Скоро', 'san-lorenzo', 'fenerbahce', 0, 0, 'Поле №2', 'https://vkvideo.ru/video_ext.php?oid=-120721420&id=456239505&hash=eabac0fc9cb32fa5&hd=4', 'Матч группового этапа. Перед началом можно показывать анонс, а после — запись встречи.', 3),
    (1773883313332::BIGINT, 'burchalkin-cup-2026', 'Группа B', '2 тур', 'День 2', DATE '2026-03-15', '10:00'::TIME, 'soon', 'Скоро', 'dinamo-minsk', 'palmeiras', 0, 0, NULL, 'https://vkvideo.ru/video_ext.php?oid=-120721420&id=456239433&hash=bea5fe2662c311f2&hd=4', '', 4),
    (1773883426669::BIGINT, 'burchalkin-cup-2026', 'Группа A', '2 тур', 'День 2', DATE '2026-03-15', '10:00'::TIME, 'soon', 'Скоро', 'almaz-antey', 'zenit', 0, 0, NULL, 'https://vkvideo.ru/video_ext.php?oid=-120721420&id=456239433&hash=bea5fe2662c311f2&hd=4', '', 5),
    (1773883471638::BIGINT, 'burchalkin-cup-2026', 'Группа B', '2 тур', 'День 2', DATE '2026-03-15', '10:00'::TIME, 'soon', 'Скоро', 'kairat', 'fenerbahce', 0, 0, NULL, 'https://vkvideo.ru/video_ext.php?oid=-120721420&id=456239433&hash=bea5fe2662c311f2&hd=4', '', 6),
    (2025051601::BIGINT, 'burchalkin-cup-2025', 'Группа B', '1 тур', 'Архив', DATE '2025-05-16', '12:00'::TIME, 'done', 'Завершен', 'zenit', 'kairat', 2, 0, 'Главное поле', 'https://www.youtube.com/embed/5qap5aO4i9A', 'Архивный матч для проверки сквозной истории клуба.', 1)
) AS data(id, tournament_slug, stage_name, round_name, matchday_label, match_date, match_time, status, status_label, home_club_slug, away_club_slug, home_score, away_score, venue, video_url, summary, sort_order)
JOIN tournaments tournament ON tournament.slug = data.tournament_slug
