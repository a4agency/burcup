...
(function() {
  ...
  "Турниры": "Tournaments",
  "Текущий сезон и архив турниров по годам.": "Current season and tournament archive by year.",
  "Архив →": "Archive →",
  "Архив": "Archive",
  "Открыть архив 2025 →": "Open 2025 archive →",
  "Розыгрыш 2024": "2024 edition",
  "Розыгрыш 2023": "2023 edition",
  "Розыгрыш 2019": "2019 edition",
  "Розыгрыш 2018": "2018 edition",
  "Архив матчей, результатов и материалов турнира.": "Archive of tournament matches, results, and materials.",
  "Позже здесь появятся команды турнира, результаты матчей, сетка, фотографии и архивные материалы розыгрыша 2025 года.": "Teams, match results, the bracket, photos, and archive materials of the 2025 edition will appear here later.",
  "Страница архива сезона с командами, сеткой и фото.": "Archive page of the season with teams, bracket, and photos.",
  "Материалы прошлогоднего турнира будут добавлены позднее.": "Materials from last year's tournament will be added later.",
  "Заглушка архива для будущего наполнения историей турнира.": "Archive placeholder for future tournament history content.",
  "Отдельная страница архива уже готова для будущих материалов.": "A dedicated archive page is already ready for future materials.",
  "Это страница-заглушка под архив 2024 года. Позже здесь можно будет собрать участников, расписание, итоги и медиаматериалы.": "This is a placeholder page for the 2024 archive. Later, participants, schedule, results, and media materials can be added here.",
  ...
  "Страница подготовлена как архив для одного из ранних розыгрышей турнира. Здесь можно будет собрать историю турнира по годам.": "This page is prepared as an archive for one of the early editions of the tournament. The tournament history can be collected here over time.",
  "Заглушка для архивной страницы 2018 года. Позже здесь появятся команды, результаты и исторические материалы турнира.": "A placeholder for the 2018 archive page. Teams, results, and historical materials will appear here later.",
  "Архив турнира": "Tournament Archive",
  "Архив турнира - Burchalkin Cup": "Tournament Archive - Burchalkin Cup",
  "← Назад к результатам": "← Back to results",
  "Архивный розыгрыш турнира": "Archived tournament edition",
  "Архивный розыгрыш 15 - 17 мая 2025": "Archived edition 15 - 17 May 2025",
  "Что входит в архив": "What's in the archive",
  ...
  "Страница уже готова как архивная точка входа. Материалы можно будет постепенно добавить позже.": "The page is already ready as an archive entry point. Materials can be added gradually later.",
  ...
  "На сайте уже доступны основные разделы будущего розыгрыша: команды, матчи, результаты, медиа и архив прошлых лет. По мере подготовки турнира здесь будут появляться новые материалы и обновления.": "The main sections of the upcoming edition are already available on the website: teams, matches, results, media, and the archive of previous years. New materials and updates will appear here as the tournament preparation continues.",
  ...
  "Архив прошлых розыгрышей и новые страницы турниров уже подготовлены так, чтобы впоследствии можно было хранить полную историю каждого сезона.": "The archive of previous editions and the new tournament pages are already prepared so that the complete history of each season can be stored later."
};
  const months = {
  "января": "January",
  "февраля": "February",
