...
(function() {
  ...
  const AUTO_TRANSLATION_PARALLEL_REQUESTS = 6;
  ...
  "Легенда ленинградского футбола": "The Legend of Leningrad Football",
  "Начало большого футбола": "The Beginning of a Great Football Career",
  "Форвард «Зенита»": "Zenit forward",
  "Форвард «Зенита» и сборной": "Forward for Zenit and the Soviet national team",
  "Тренерская карьера и память": "Coaching Career and Legacy",
  "Тренерский путь": "Coaching Career",
  "Наследие и память": "Legacy and Remembrance",
  "Итоги": "Results",
  ...
  "Фотографии Льва Бурчалкина": "Photos of Lev Burchalkin",
  "Хозяева": "Home",
  "Гости": "Away",
  "Стадион": "Stadium",
  ...
  "Лев Дмитриевич Бурчалкин родился 9 января 1939 года в Ленинграде и стал одной из самых любимых фигур в истории петербургского футбола. Нападающий, которого зрители называли просто «Лева», навсегда вошёл в историю «Зенита» своей самоотдачей, голевым чутьём и редкой преданностью родному клубу.": "Lev Dmitrievich Burchalkin was born on January 9, 1939, in Leningrad and became one of the most beloved figures in the history of Saint Petersburg football. The forward whom fans simply called Lyova became a permanent part of Zenit’s history thanks to his commitment, scoring instinct, and rare loyalty to his home club.",
  "Легендарный ленинградский футболист, в честь которого назван турнир.": "A legendary footballer from Leningrad after whom the tournament is named.",
  ...
  "Питерские болельщики называли его просто «Лева», а журналисты дали ему имя, которое осталось в памяти на десятилетия — «Бурчалкин-Выручалкин».": "Saint Petersburg fans simply called him Lyova, and journalists gave him a nickname that stayed in memory for decades — “Burchalkin-Vyruchalkin”.",
  "годы жизни": "life span",
  "за «Зенит»": "with Zenit",
  "в чемпионате": "in league matches",
  "за основной состав": "for the first team",
  "капитан команды": "as captain",
  "лучший бомбардир «Зенита»": "Zenit’s top scorer",
