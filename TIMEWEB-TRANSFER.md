...
9. If the admin save still fails with `Unknown column photo_reports_enabled`, apply `database/mysql-add-media-photo-reports-flag.sql` in phpMyAdmin.
10. Re-test admin login and one upload.
